...
import com.princely.ecommerce.product.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.princely.ecommerce.product.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
