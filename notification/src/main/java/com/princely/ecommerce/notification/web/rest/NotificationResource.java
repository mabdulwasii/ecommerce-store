package com.princely.ecommerce.notification.web.rest;

import com.princely.ecommerce.notification.domain.Notification;
import com.princely.ecommerce.notification.repository.NotificationRepository;
import com.princely.ecommerce.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.princely.ecommerce.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
