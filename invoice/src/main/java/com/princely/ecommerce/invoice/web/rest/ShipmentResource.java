...
import com.princely.ecommerce.invoice.domain.Shipment;
import com.princely.ecommerce.invoice.repository.ShipmentRepository;
import com.princely.ecommerce.invoice.service.ShipmentService;
import com.princely.ecommerce.invoice.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.princely.ecommerce.invoice.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
